        ...
        <div className="ml-36 mr-36">
            ...
            <div>
                <ul>
                    ...
                    <li className="py-3 border-b-2">ADDRESS: {user?.address?.[0]?.add}</li>
                    <li className="py-3 border-b-2">COUNTRY:India </li>
                    <li className="py-3 border-b-2">ZIP: {user?.address?.[0]?.pincode} </li>
                    <li className="py-3 mb-5 border-b-2">PHONE:{user?.number}</li>
                </ul>
